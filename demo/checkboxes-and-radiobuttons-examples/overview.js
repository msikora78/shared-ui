	...
	var data = {
		...
		html:'\
			<div id="checkboxes-container">\n\
				...
				<input id="chk" type="checkbox" value="3" /><label for="chk" style="display: inline !important;">Option 3</label>\n\
				<br>\n\
			...
			<div id="radiobuttons-container">\n\
				...
				<input id="rdo" type="radio" name="group" value="3" /><label for="rdo" style="display: inline !important;">Option 3</label>\n\
				<br>\n\
